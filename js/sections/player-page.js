...
import { getFullPlayer, FIRST_STATS_YEAR } from '../data/player-full.js?v=74';
...
import { getCareer, getPlayerAwards, buildCareers } from '../data/careers.js?v=70';
import { topinaBlock, awardsBlock } from '../components/player-modal.js?v=87';
...
import { getAdvancedSeasons, getTeamAdvanced, getCombineDraft, getTeamDraftHistory, getDraftPeers, getAdvancedPool } from '../data/context-score.js?v=62';
import { getTeamIdentity } from '../data/nfl-teams.js?v=1';
import { getTeamRoster, getTeamInjuries, getTeamStarters, getPlayerInjuries, currentNflSeason } from '../data/nfl-team-extras.js?v=61';
...
import { decomposeSeason, seasonVerdict, getPerfCauses, describeCauses } from '../data/perf-explain.js?v=68';
