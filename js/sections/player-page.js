...
import { getTeamContext, getTeamStats } from '../data/nfl-team-stats.js?v=529';
...
import { getAdvancedSeasons, getTeamAdvanced, getCombineDraft, getTeamDraftHistory, getDraftPeers, getAdvancedPool } from '../data/context-score.js?v=584';
import { getTeamIdentity } from '../data/nfl-teams.js?v=510';
import { getTeamRoster, getTeamInjuries, getTeamStarters, getPlayerInjuries, currentNflSeason } from '../data/nfl-team-extras.js?v=581';
