...
import { getFullPlayer, FIRST_STATS_YEAR } from '../data/player-full.js?v=67';
...
import { getCareer, getPlayerAwards, buildCareers } from '../data/careers.js?v=64';
import { topinaBlock, awardsBlock } from '../components/player-modal.js?v=81';
import { getSeasonProjections, getSeasonStats, matchProjection } from '../data/projections.js?v=69';
import { playerImageService } from '../services/player-image-service.js?v=15';
import { canonAbbr } from '../data/nfl-schedule.js?v=20';
import { CURRENT_SEASON } from '../data.js?v=33';
import { getAdvancedSeasons, getTeamAdvanced, getCombineDraft, getTeamDraftHistory, getDraftPeers, getAdvancedPool } from '../data/context-score.js?v=56';
import { getTeamIdentity } from '../data/nfl-teams.js?v=1';
import { getTeamRoster, getTeamInjuries, getTeamStarters, getPlayerInjuries, currentNflSeason } from '../data/nfl-team-extras.js?v=56';
...
import { decomposeSeason, seasonVerdict, getPerfCauses, describeCauses } from '../data/perf-explain.js?v=61';
