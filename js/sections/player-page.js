...
import { getTeamContext, getTeamStats } from '../data/nfl-team-stats.js?v=558';
...
import { getAdvancedSeasons, getTeamAdvanced, getCombineDraft, getTeamDraftHistory, getDraftPeers, getAdvancedPool } from '../data/context-score.js?v=610';
import { getTeamIdentity } from '../data/nfl-teams.js?v=513';
import { getTeamRoster, getTeamInjuries, getTeamStarters, getPlayerInjuries, currentNflSeason } from '../data/nfl-team-extras.js?v=919';
