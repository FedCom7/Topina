...
import { getHonorsBundle, honorsSeasons } from '../data/honors.js?v=72';
import { TEAMS } from './team.js?v=87';
import { paniniCard, initPlayerModal, hydratePaniniBadges } from '../components/player-modal.js?v=92';
