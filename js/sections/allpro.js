...
import { getHonorsBundle, honorsSeasons } from '../data/honors.js?v=584';
import { TEAMS } from './team.js?v=600';
import { paniniCard, initPlayerModal, hydratePaniniBadges } from '../components/player-modal.js?v=606';
