...
import { getHonorsBundle, honorsSeasons } from '../data/honors.js?v=631';
import { TEAMS } from './team.js?v=741';
import { paniniCard, initPlayerModal, hydratePaniniBadges } from '../components/player-modal.js?v=747';
