...
import { getSeasonProjections, matchProjection } from '../data/projections.js?v=89';
...
import { predictSeason } from '../data/draft-predictions.js?v=84';
import { getContextScore, getDraftModel } from '../data/context-score.js?v=73';
