...
import { fetchFantasyData, displayName, teamNameHTML, getSeasonConfig } from '../data.js?v=580';
...
import { buildCareers } from '../data/careers.js?v=642';
...
import { dumbbell, dotPlot, multiLine, inkFor } from '../ui/charts.js?v=8';
