...
import { getSeasonProjections, getSeasonStats, matchProjection, normName } from '../data/projections.js?v=601';
...
import { perfWaterfall, injuryLabelForSeason, injuryHistoryDetails, fmt0 } from './player-page.js?v=970';
