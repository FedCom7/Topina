...
import { esc, teamLogoUrl, buildPlayerIndex, teamResults, playerResults, resultRow } from '../data/player-search-core.js?v=51';
import { getTeamStats } from '../data/nfl-team-stats.js?v=19';
import { getLeagueTeamsAdvanced } from '../data/context-score.js?v=56';
import { canonAbbr } from '../data/nfl-schedule.js?v=20';
import { getTeamIdentity } from '../data/nfl-teams.js?v=1';
import { getSeasonStats, getSeasonProjections } from '../data/projections.js?v=69';
