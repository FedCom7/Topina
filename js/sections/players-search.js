...
import { getLeagueStandings, getLeaguePowerRankings, getNews, getLeagueLeaders } from '../data/nfl-team-live.js?v=586';
import { CURRENT_SEASON } from '../data.js?v=534';
import { esc, teamLogoUrl, buildPlayerIndex, teamResults, playerResults, resultRow } from '../data/player-search-core.js?v=576';
import { getTeamStats } from '../data/nfl-team-stats.js?v=527';
import { getLeagueTeamsAdvanced } from '../data/context-score.js?v=582';
