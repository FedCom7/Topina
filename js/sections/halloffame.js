...
import { electHallOfFame, FIRST_CLASS_YEAR, MIN_SEASONS, WAIT_YEARS } from '../data/hall-of-fame.js?v=584';
import { playerImageService } from '../services/player-image-service.js?v=515';
import { paniniCard, initPlayerModal } from '../components/player-modal.js?v=606';
