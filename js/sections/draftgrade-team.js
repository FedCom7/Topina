...
import { getHistoryIndex, trendBadge, historyLine, peakNote } from '../data/player-history.js?v=21';
...
} from './draftgrades.js?v=39';
import { getContextScore, getDraftModel } from '../data/context-score.js?v=12';
import { evaluateLeague, TSI_WEIGHTS, TSI_LABELS } from '../data/team-eval.js?v=11';
