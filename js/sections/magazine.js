...
import { weekPosRanks, recapArticle, diffMakers, statLine, playerComment, seasonAvg, teamStatTotals } from '../data/matchup-analysis.js?v=4';
import {
    ...
    TEAMMATE_PRAISE,
} from '../data/magazine-voices.js?v=8';
