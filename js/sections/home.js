...
import { paniniCard, hydratePaniniBadges, initPlayerModal } from '../components/player-modal.js?v=787';
import { teamsCardsHTML } from './teams.js?v=744';
...
import { computeGrades, makeEvaluator, gradeLetterHTML } from './draftgrades.js?v=827';
