...
import { replacementLevels, demandByPos, NUM_TEAMS, getByeWeeks } from './team-eval.js?v=541';
import { NEED_TARGET, marketSurvival, getAdpDispersion } from './draft-grade.js?v=12';
import { computeStrategy, pickNumber, roundOf, ROUND_MAX, STRATEGY_POSITIONS } from './draft-strategy.js?v=26';
