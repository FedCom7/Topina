...
import { getCareer, getPlayerAwards } from '../data/careers.js?v=76';
import { getSeasonStats, getSeasonProjections, matchProjection, normName } from '../data/projections.js?v=82';
import { TEAMS } from '../sections/team.js?v=87';
import { playerImageService } from '../services/player-image-service.js?v=15';
import { getPlayerInfo } from '../data/player-full.js?v=80';
import { getHallOfFameYear } from '../data/hall-of-fame.js?v=71';
