 ...
 */
import { initHome } from './sections/home.js?v=102';
import { initGameCenter } from './sections/game-center.js?v=101';
import { initStandings, initPlayoffs } from './sections/standings.js?v=97';
import { initDraft } from './sections/draft.js?v=99';
import { initDraftGrades } from './sections/draftgrades.js?v=88';
import { initDraftGradeTeam } from './sections/draftgrade-team.js?v=88';
import { initPlayerPage } from './sections/player-page.js?v=312';
import { initNflTeamPage } from './sections/nfl-team-page.js?v=310';
import { initPlayersSearch } from './sections/players-search.js?v=312';
import { initStats } from './sections/stats.js?v=105';
import { initHistory } from './sections/history.js?v=82';
import { initHonors } from './sections/honors.js?v=65';
import { initAllPro } from './sections/allpro.js?v=71';
import { initHallOfFame } from './sections/halloffame.js?v=88';
import { initTeam } from './sections/team.js?v=83';
import { initTeams } from './sections/teams.js?v=61';
import { initGame } from './sections/game.js?v=79';
import { initAnalysis } from './sections/analysis.js?v=74';
import { initMagazine } from './sections/magazine.js?v=78';
import { initLive } from './sections/live.js?v=188';
import { initNavbar } from './ui/navbar.js?v=68';
