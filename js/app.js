 ...
 */
import { initHome } from './sections/home.js?v=1083';
import { initGameCenter } from './sections/game-center.js?v=820';
import { initStandings, initPlayoffs } from './sections/standings.js?v=763';
import { initDraft } from './sections/draft.js?v=803';
import { initDraftGrades } from './sections/draftgrades.js?v=815';
import { initProjections } from './sections/projections.js?v=616';
import { initManagerDna } from './sections/managerdna.js?v=46';
import { initManagerDnaTeam } from './sections/managerdna-team.js?v=813';
import { initDraftGradeTeam } from './sections/draftgrade-team.js?v=815';
import { initPlayerPage } from './sections/player-page.js?v=1058';
import { initNflTeamPage } from './sections/nfl-team-page.js?v=1089';
import { initPlayersSearch } from './sections/players-search.js?v=996';
import { initStats } from './sections/stats.js?v=868';
import { initHistory } from './sections/history.js?v=751';
import { initHonors } from './sections/honors.js?v=736';
import { initAllPro } from './sections/allpro.js?v=748';
import { initHallOfFame } from './sections/halloffame.js?v=764';
import { initTeam } from './sections/team.js?v=824';
import { initTeams } from './sections/teams.js?v=733';
import { initGame } from './sections/game.js?v=817';
import { initAnalysis } from './sections/analysis.js?v=841';
import { initLeaders } from './sections/leaders.js?v=77';
import { initWaivers } from './sections/waivers.js?v=70';
import { initMagazine } from './sections/magazine.js?v=785';
import { initLive } from './sections/live.js?v=1095';
