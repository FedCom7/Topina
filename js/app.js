 ...
 */
import { initHome } from './sections/home.js?v=624';
...
import { initDraftGrades } from './sections/draftgrades.js?v=641';
import { initProjections } from './sections/projections.js?v=9';
import { initDraftGradeTeam } from './sections/draftgrade-team.js?v=648';
import { initPlayerPage } from './sections/player-page.js?v=860';
import { initNflTeamPage } from './sections/nfl-team-page.js?v=918';
import { initPlayersSearch } from './sections/players-search.js?v=902';
import { initStats } from './sections/stats.js?v=646';
...
import { initGame } from './sections/game.js?v=629';
import { initAnalysis } from './sections/analysis.js?v=611';
import { initMagazine } from './sections/magazine.js?v=621';
import { initLive } from './sections/live.js?v=775';
