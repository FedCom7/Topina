 ...
 */
import { initHome } from './sections/home.js?v=836';
import { initGameCenter } from './sections/game-center.js?v=764';
import { initStandings, initPlayoffs } from './sections/standings.js?v=722';
import { initDraft } from './sections/draft.js?v=755';
import { initDraftGrades } from './sections/draftgrades.js?v=760';
import { initProjections } from './sections/projections.js?v=121';
import { initManagerDna } from './sections/managerdna.js?v=6';
import { initManagerDnaTeam } from './sections/managerdna-team.js?v=6';
import { initDraftGradeTeam } from './sections/draftgrade-team.js?v=767';
import { initPlayerPage } from './sections/player-page.js?v=989';
import { initNflTeamPage } from './sections/nfl-team-page.js?v=1042';
import { initPlayersSearch } from './sections/players-search.js?v=983';
import { initStats } from './sections/stats.js?v=816';
import { initHistory } from './sections/history.js?v=710';
import { initHonors } from './sections/honors.js?v=694';
import { initAllPro } from './sections/allpro.js?v=702';
import { initHallOfFame } from './sections/halloffame.js?v=718';
import { initTeam } from './sections/team.js?v=713';
import { initTeams } from './sections/teams.js?v=687';
import { initGame } from './sections/game.js?v=775';
import { initAnalysis } from './sections/analysis.js?v=779';
import { initLeaders } from './sections/leaders.js?v=16';
import { initWaivers } from './sections/waivers.js?v=19';
import { initMagazine } from './sections/magazine.js?v=743';
import { initLive } from './sections/live.js?v=1026';
