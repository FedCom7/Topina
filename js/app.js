...
import { initPlayerPage } from './sections/player-page.js?v=102';
import { initNflTeamPage } from './sections/nfl-team-page.js?v=57';
import { initPlayersSearch } from './sections/players-search.js?v=54';
