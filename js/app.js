 ...
 */
import { initHome } from './sections/home.js?v=1081';
import { initGameCenter } from './sections/game-center.js?v=818';
import { initStandings, initPlayoffs } from './sections/standings.js?v=762';
import { initDraft } from './sections/draft.js?v=801';
import { initDraftGrades } from './sections/draftgrades.js?v=813';
import { initProjections } from './sections/projections.js?v=614';
import { initManagerDna } from './sections/managerdna.js?v=45';
import { initManagerDnaTeam } from './sections/managerdna-team.js?v=812';
import { initDraftGradeTeam } from './sections/draftgrade-team.js?v=813';
import { initPlayerPage } from './sections/player-page.js?v=1056';
import { initNflTeamPage } from './sections/nfl-team-page.js?v=1088';
import { initPlayersSearch } from './sections/players-search.js?v=996';
import { initStats } from './sections/stats.js?v=867';
import { initHistory } from './sections/history.js?v=750';
import { initHonors } from './sections/honors.js?v=735';
import { initAllPro } from './sections/allpro.js?v=746';
import { initHallOfFame } from './sections/halloffame.js?v=762';
import { initTeam } from './sections/team.js?v=822';
import { initTeams } from './sections/teams.js?v=732';
import { initGame } from './sections/game.js?v=816';
import { initAnalysis } from './sections/analysis.js?v=840';
import { initLeaders } from './sections/leaders.js?v=76';
import { initWaivers } from './sections/waivers.js?v=69';
import { initMagazine } from './sections/magazine.js?v=784';
import { initLive } from './sections/live.js?v=1092';
