 ...
 */
import { initHome } from './sections/home.js?v=1088';
import { initGameCenter } from './sections/game-center.js?v=830';
import { initStandings, initPlayoffs } from './sections/standings.js?v=772';
import { initDraft } from './sections/draft.js?v=808';
import { initDraftGrades } from './sections/draftgrades.js?v=820';
import { initProjections } from './sections/projections.js?v=621';
import { initManagerDna } from './sections/managerdna.js?v=50';
import { initManagerDnaTeam } from './sections/managerdna-team.js?v=817';
import { initDraftGradeTeam } from './sections/draftgrade-team.js?v=820';
import { initPlayerPage } from './sections/player-page.js?v=1065';
import { initNflTeamPage } from './sections/nfl-team-page.js?v=1108';
import { initPlayersSearch } from './sections/players-search.js?v=1001';
import { initStats } from './sections/stats.js?v=882';
import { initHistory } from './sections/history.js?v=755';
import { initHonors } from './sections/honors.js?v=740';
import { initAllPro } from './sections/allpro.js?v=753';
import { initHallOfFame } from './sections/halloffame.js?v=769';
import { initTeam } from './sections/team.js?v=829';
import { initTeams } from './sections/teams.js?v=737';
import { initGame } from './sections/game.js?v=822';
import { initAnalysis } from './sections/analysis.js?v=856';
import { initLeaders } from './sections/leaders.js?v=91';
import { initWaivers } from './sections/waivers.js?v=84';
import { initMagazine } from './sections/magazine.js?v=789';
import { initLive } from './sections/live.js?v=1116';
import { initNavbar } from './ui/navbar.js?v=679';
