...
import { initGameCenter } from './sections/game-center.js?v=825';
import { initStandings, initPlayoffs } from './sections/standings.js?v=767';
...
import { initNflTeamPage } from './sections/nfl-team-page.js?v=1094';
import { initPlayersSearch } from './sections/players-search.js?v=1001';
import { initStats } from './sections/stats.js?v=872';
...
import { initAnalysis } from './sections/analysis.js?v=845';
import { initLeaders } from './sections/leaders.js?v=81';
import { initWaivers } from './sections/waivers.js?v=74';
import { initMagazine } from './sections/magazine.js?v=789';
import { initLive } from './sections/live.js?v=1101';
import { initNavbar } from './ui/navbar.js?v=670';
