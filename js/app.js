...
import { initPlayerPage } from './sections/player-page.js?v=73';
import { initNflTeamPage } from './sections/nfl-team-page.js?v=86';
import { initPlayersSearch } from './sections/players-search.js?v=27';
...
import { initLive } from './sections/live.js?v=79';
import { initNavbar } from './ui/navbar.js?v=30';
