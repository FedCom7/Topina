 ...
 */
import { initHome } from './sections/home.js?v=867';
...
import { initDraftGrades } from './sections/draftgrades.js?v=791';
import { initProjections } from './sections/projections.js?v=152';
import { initManagerDna } from './sections/managerdna.js?v=33';
import { initManagerDnaTeam } from './sections/managerdna-team.js?v=33';
import { initDraftGradeTeam } from './sections/draftgrade-team.js?v=798';
import { initPlayerPage } from './sections/player-page.js?v=1021';
import { initNflTeamPage } from './sections/nfl-team-page.js?v=1070';
import { initPlayersSearch } from './sections/players-search.js?v=987';
import { initStats } from './sections/stats.js?v=855';
import { initHistory } from './sections/history.js?v=738';
import { initHonors } from './sections/honors.js?v=722';
import { initAllPro } from './sections/allpro.js?v=733';
import { initHallOfFame } from './sections/halloffame.js?v=750';
import { initTeam } from './sections/team.js?v=744';
import { initTeams } from './sections/teams.js?v=715';
import { initGame } from './sections/game.js?v=803';
import { initAnalysis } from './sections/analysis.js?v=817';
import { initLeaders } from './sections/leaders.js?v=64';
import { initWaivers } from './sections/waivers.js?v=54';
