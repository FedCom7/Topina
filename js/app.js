 ...
 */
import { initHome } from './sections/home.js?v=1092';
import { initGameCenter } from './sections/game-center.js?v=833';
import { initStandings, initPlayoffs } from './sections/standings.js?v=775';
import { initDraft } from './sections/draft.js?v=811';
import { initDraftGrades } from './sections/draftgrades.js?v=823';
import { initProjections } from './sections/projections.js?v=625';
import { initManagerDna } from './sections/managerdna.js?v=53';
import { initManagerDnaTeam } from './sections/managerdna-team.js?v=820';
import { initDraftGradeTeam } from './sections/draftgrade-team.js?v=823';
import { initPlayerPage } from './sections/player-page.js?v=1069';
import { initNflTeamPage } from './sections/nfl-team-page.js?v=1110';
import { initPlayersSearch } from './sections/players-search.js?v=1001';
import { initStats } from './sections/stats.js?v=894';
import { initHistory } from './sections/history.js?v=758';
import { initHonors } from './sections/honors.js?v=743';
import { initAllPro } from './sections/allpro.js?v=756';
import { initHallOfFame } from './sections/halloffame.js?v=771';
import { initTeam } from './sections/team.js?v=833';
import { initTeams } from './sections/teams.js?v=740';
import { initGame } from './sections/game.js?v=825';
import { initAnalysis } from './sections/analysis.js?v=868';
import { initLeaders } from './sections/leaders.js?v=100';
import { initWaivers } from './sections/waivers.js?v=95';
import { initMagazine } from './sections/magazine.js?v=792';
import { initLive } from './sections/live.js?v=1119';
import { initNavbar } from './ui/navbar.js?v=682';
